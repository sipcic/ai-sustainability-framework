...
- **Employment** — participation of people in productive activity.  
- **Consumption** — adequacy of aggregate demand to sustain growth.  
- **Median income** — fairness in distribution of productivity gains.  
- **Renewable energy share** — ecological progress toward clean production.  
- **Carbon emissions** — cost of growth in environmental terms.  
- **Inequality** — measure of social cohesion and fairness.  

---

## 1.1 Modeling Sustainability: Additive vs. Multiplicative Approaches

Before selecting the mathematical formulation, it is useful to understand what each component represents in context.  
Each term in the SLI corresponds to one dimension of sustainable life:  
- **Economic participation** through employment and wages ensures that productivity gains translate into livelihoods.  
- **Demand adequacy** through consumption supports a stable economic cycle.  
- **Ecological balance** through renewables and emissions captures the energy transition.  
- **Equity** through income and inequality reflects how fairly the system’s benefits are distributed.  

Formally representing sustainability requires combining these six variables into a single function that can be evaluated and compared across scenarios. Two principal approaches exist.
